namespace MVC5Week1.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw客戶完整資料Repository Getvw客戶完整資料Repository()
		{
			var repository = new vw客戶完整資料Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw客戶完整資料Repository Getvw客戶完整資料Repository(IUnitOfWork unitOfWork)
		{
			var repository = new vw客戶完整資料Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
